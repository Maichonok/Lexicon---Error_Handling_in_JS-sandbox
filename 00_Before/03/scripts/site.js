...
function initializeLoans() {
  ...
  la2.LoanPurpose =
    "My partner needs the loan to buy new equipment for our medical practice";
  la2.LoanAmount = 4800;
...
function loadApplication() {
  ...
  if (SelectedLoanApplication != undefined) {
    ...
    document.getElementById("inputName").value =
      SelectedLoanApplication.ApplicantName;
    document.getElementById("inputDoBMonth").value =
      SelectedLoanApplication.ApplicantDateOfBirth.getMonth() + 1;
    document.getElementById("inputDoBDay").value =
      SelectedLoanApplication.ApplicantDateOfBirth.getDate();
    document.getElementById("inputDoBYear").value =
      SelectedLoanApplication.ApplicantDateOfBirth.getFullYear();
    document.getElementById("inputAnnualIncome").value =
      SelectedLoanApplication.ApplicantAnnualIncome;
    document.getElementById("inputAnnualIncome").value =
      SelectedLoanApplication.ApplicantAnnualIncome;
    ...
    document.getElementById("inputLoanPurpose").value =
      SelectedLoanApplication.LoanPurpose;
...
function generateRickProfile(la) {
  ...
  if (age < 18) {
    reviewText =
      "will not be reviewed, because you have to be 18 years or older";
  } else {
